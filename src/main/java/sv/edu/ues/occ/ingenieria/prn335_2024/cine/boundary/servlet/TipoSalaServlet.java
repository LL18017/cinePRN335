...
//                out.println("<hr>");
//                out.println("<h2>Tipo de sala creado</h2>"+nombre+"<br>");
//                out.println("</body>");
//                return;
//            }catch (Exception e) {
//                e.printStackTrace();
//            }
//        }else{
//            resp.setStatu//package sv.edu.ues.occ.ingenieria.prn335_2024.cine.boundary.servlet;
//
//import jakarta.inject.Inject;
//import jakarta.servlet.ServletException;
//import jakarta.servlet.annotation.WebServlet;
...
//
//}
//s(HttpServletResponse.SC_PRECONDITION_FAILED);
//        }
//    }
//    @Override
//    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
